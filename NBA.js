...
class NBA {
    ...
    modifyRow() {
        ...
        db.get(sql, id, (err, rows) => {
            ...
            if(rows===undefined){
                ...
                <a href="/">Back to Home</a></form></body> `)}});}
    ...
    addRow() {
        ...
        const team = [this.req.body.id, this.req.body.abbreviation, this.req.body.city, this.req.body.conference, this.req.body.division,
            this.req.body.full_name, this.req.body.name];
        db.run(sql, team, err => {
            if (err) {
                return console.error(err.message);
            }
